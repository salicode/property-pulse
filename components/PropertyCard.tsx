...
import {FaBed, FaBath, FaRulerCombined, FaMoneyBill, FaLocationDot, FaMarker } from 'react-icons/fa6';
import { Property } from '../app/properties/types/property';
            ...
            <div className="p-4">
              ...
              <div className="flex flex-col lg:flex-row justify-between mb-4">
                <div className="flex align-middle gap-2 mb-4 lg:mb-0">
                  ...
                  ></i> */}
                  <FaMarker className='text-orange-700 mt-1'/>
